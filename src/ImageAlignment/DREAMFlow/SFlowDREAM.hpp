...
#ifndef SRC_IMAGEALIGNMENT_FLOWFRAMEWORKS_SFLOWDREAM_HPP_
#define SRC_IMAGEALIGNMENT_FLOWFRAMEWORKS_SFLOWDREAM_HPP_
...
#endif /* SRC_IMAGEALIGNMENT_FLOWFRAMEWORKS_SFLOWDREAM_HPP_ */
