...
class OptimizationMachineAnchors: public AlignmentMachine {
private:
    bool bFilter = true;
    
    std::vector<InterSessionAnchors> akj;
    ...
    const Camera& _cam;
public:
    OptimizationMachineAnchors(const Camera& cam, std::string _results_dir): _cam(cam){
