...
//LocalisePose6DDual::
//DualIterativeBA(gtsam::Pose3& p1frame0, gtsam::Pose3& p0frame1)
///*
...
//        return std::make_tuple(false, gp0, stats);
//    }
//    
//    clock_gettime(CLOCK_MONOTONIC, &start);
//    
//    LocalizePose6D lp6d_p(cam_, p3d_, p2d1_);
//    lp6d_p.setRANSACMethod(LocalizePose6D::METHOD::P3P);
//    bool suc;
//    gtsam::Pose3 p1frame0_guess;
//    std::tie<suc, p1frame0_guess, ignore> = lp6d_p.UseRANSAC();
//    if(not suc)
//    {
//        std::cout << "Localization failed due to RANSAC failure on set p"<<std::endl;
//        return std::make_tuple(suc, p1frame0_guess, stats);
//    }
//    
//    LocalizePose6D lp6d_b(cam_, b3d, b2d0);
//    lp6d_b.setRANSACMethod(LocalizePose6D::METHOD::P3P);
//    gtsam::Pose3 p0frame1_guess;
//    std::tie<suc, p0frame1_guess, ignore> = lp6d_b.UseRANSAC();
//    if(not suc)
//    {
//        std::cout << "Localization failed due to RANSAC failure on set b"<<std::endl;
//        return std::make_tuple(suc, p0frame1_guess, stats);
//    }
//
//    
