...
class LocalizationFactor: public gtsam::NoiseModelFactor2<gtsam::Pose3, gtsam::Pose3>{
public:
    typedef gtsam::Pose3 T;
private:
    typedef LocalizationFactor This;
    typedef gtsam::NoiseModelFactor2<gtsam::Pose3, gtsam::Pose3> Base;

    gtsam::Pose3 _p0;
    gtsam::Pose3 _p1;
public:
    typedef typename boost::shared_ptr<LocalizationFactor> shared_ptr;
    ...
    LocalizationFactor(gtsam::Key j1, gtsam::Key j2, gtsam::Pose3 p0, gtsam::Pose3 p1, const gtsam::SharedNoiseModel& model):
...
#endif /* defined(__BundleAdjustOneDataset__LocalizationFactor__) */
